package com.ruoyi.project.agriculture.income_contrast.domain;
...
/**
 * 年度人均收入对比对象 agr_income
 * 
 * @author Chen
 * @date 2023-03-02
 */
public class AgrIncomeContrast extends BaseEntity
{
    ...
    /** 本年人均收入（以户编号为统计单位） */
    @Excel(name = "本年人均收入", readConverterExp = "以=户编号为统计单位")
